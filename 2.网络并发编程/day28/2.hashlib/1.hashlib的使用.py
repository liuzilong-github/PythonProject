...
md5算法: 可以把字符串变成具有固定长的32位十六进制字符串
"""

# 撞库
"""
112233 => 00b7691d86d96aebd21dd9e138f90840
...
# (二) sha系列算法
"""
无论是加盐,还是加密密码,都需要数据类型为二进制的字节流
"""
# hs = hashlib.sha1()	# 结果是具有40位固定长度的十六进制字符串
hs = hashlib.sha512("XGIRLww_".encode())	# 结果是具有128位固定长度的十六进制字符串
